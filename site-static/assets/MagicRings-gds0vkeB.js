...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Sa(e,t,n){let r=new Float32Array(ca),i=new q(0,1,0);return new ri({name:`SphericalGaussianBlur`,defines:{n:ca,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ta(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ca(){return new ri({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ta(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wa(){return new ri({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ta(),fragmentShader:`
	...
	`}var Ea=class extends Ot{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ur(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Qo={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function $o(e,t){let n=Qo[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var es=new q;function ts(){return Y.getLuminanceCoefficients(es),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${es.x.toFixed(4)}, ${es.y.toFixed(4)}, ${es.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Wo(i,i.VERTEX_SHADER,y),S=Wo(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Xo(i,x,`vertex`),n=Xo(i,S,`fragment`);U(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;function hc({color:e=`#fc42ff`,colorTwo:t=`#42fcff`,speed:n=1,ringCount:i=6,attenuation:a=10,lineThickness:o=2,baseRadius:s=.35,radiusStep:c=.1,scaleRate:l=.1,opacity:u=1,blur:d=0,noiseAmount:f=.1,rotation:p=0,ringGap:m=1.5,fadeIn:h=.7,fadeOut:g=.5,followMouse:_=!1,mouseInfluence:v=.2,hoverScale:y=1.2,parallax:b=.05,clickBurst:x=!1,maxDpr:S=1.5}){let C=(0,r.useRef)(null),w=(0,r.useRef)(null),T=(0,r.useRef)([0,0]),E=(0,r.useRef)([0,0]),D=(0,r.useRef)(0),O=(0,r.useRef)(!1),k=(0,r.useRef)(0);return w.current={color:e,colorTwo:t,speed:n,ringCount:i,attenuation:a,lineThickness:o,baseRadius:s,radiusStep:c,scaleRate:l,opacity:u,noiseAmount:f,rotation:p,ringGap:m,fadeIn:h,fadeOut:g,followMouse:_,mouseInfluence:v,hoverScale:y,parallax:b,clickBurst:x},(0,r.useEffect)(()=>{let e=C.current;if(!e)return;let t;try{t=new dc({alpha:!0,antialias:!1,powerPreference:`low-power`})}catch{return}if(!t.capabilities.isWebGL2){t.dispose();return}t.setClearColor(0,0),e.appendChild(t.domElement);let n=new mn,r=new ji(-.5,.5,.5,-.5,.1,10);r.position.z=1;let i={uTime:{value:0},uAttenuation:{value:0},uResolution:{value:new K},uColor:{value:new X},uColorTwo:{value:new X},uLineThickness:{value:0},uBaseRadius:{value:0},uRadiusStep:{value:0},uScaleRate:{value:0},uRingCount:{value:0},uOpacity:{value:1},uNoiseAmount:{value:0},uRotation:{value:0},uRingGap:{value:1.6},uFadeIn:{value:.5},uFadeOut:{value:.75},uMouse:{value:new K},uMouseInfluence:{value:0},uHoverAmount:{value:0},uHoverScale:{value:1},uParallax:{value:0},uBurst:{value:0}},a=new ri({vertexShader:pc,fragmentShader:mc,uniforms:i,transparent:!0}),o=new Jr(1,1),s=new jr(o,a);n.add(s);let c=()=>{let n=e.clientWidth,r=e.clientHeight;if(n===0||r===0)return;let a=Math.min(window.devicePixelRatio||1,S);t.setSize(n,r,!1),t.setPixelRatio(a),i.uResolution.value.set(n*a,r*a)};c(),window.addEventListener(`resize`,c);let l=new ResizeObserver(c);l.observe(e);let u=t=>{let n=e.getBoundingClientRect();T.current[0]=(t.clientX-n.left)/n.width-.5,T.current[1]=-((t.clientY-n.top)/n.height-.5)},d=()=>{O.current=!0},f=()=>{O.current=!1,T.current[0]=0,T.current[1]=0},p=()=>{k.current=1};e.addEventListener(`mousemove`,u),e.addEventListener(`mouseenter`,d),e.addEventListener(`mouseleave`,f),e.addEventListener(`click`,p);let m,h=document.hidden,g=()=>{let e=document.hidden;e!==h&&(h=e,h?m&&=(cancelAnimationFrame(m),0):m=requestAnimationFrame(_))};document.addEventListener(`visibilitychange`,g);let _=e=>{if(h)return;m=requestAnimationFrame(_);let a=w.current;E.current[0]+=(T.current[0]-E.current[0])*.08,E.current[1]+=(T.current[1]-E.current[1])*.08,D.current+=(+!!O.current-D.current)*.08,k.current*=.95,k.current<.001&&(k.current=0),i.uTime.value=e*.001*a.speed,i.uAttenuation.value=a.attenuation,i.uColor.value.set(a.color),i.uColorTwo.value.set(a.colorTwo),i.uLineThickness.value=a.lineThickness,i.uBaseRadius.value=a.baseRadius,i.uRadiusStep.value=a.radiusStep,i.uScaleRate.value=a.scaleRate,i.uRingCount.value=a.ringCount,i.uOpacity.value=a.opacity,i.uNoiseAmount.value=a.noiseAmount,i.uRotation.value=a.rotation*Math.PI/180,i.uRingGap.value=a.ringGap,i.uFadeIn.value=a.fadeIn,i.uFadeOut.value=a.fadeOut,i.uMouse.value.set(E.current[0],E.current[1]),i.uMouseInfluence.value=a.followMouse?a.mouseInfluence:0,i.uHoverAmount.value=D.current,i.uHoverScale.value=a.hoverScale,i.uParallax.value=a.parallax,i.uBurst.value=a.clickBurst?k.current:0,t.render(n,r)};return m=requestAnimationFrame(_),()=>{m&&cancelAnimationFrame(m),window.removeEventListener(`resize`,c),document.removeEventListener(`visibilitychange`,g),l.disconnect(),e.removeEventListener(`mousemove`,u),e.removeEventListener(`mouseenter`,d),e.removeEventListener(`mouseleave`,f),e.removeEventListener(`click`,p);try{e.removeChild(t.domElement)}catch{}o.dispose(),a.dispose(),t.dispose()}},[]),(0,fc.jsx)(`div`,{ref:C,className:`magic-rings-container`,style:d>0?{filter:`blur(${d}px)`}:void 0})}export{hc as default};