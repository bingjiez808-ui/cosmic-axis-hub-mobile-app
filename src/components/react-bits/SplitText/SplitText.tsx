/**
 * SplitText — React Bits (JS + CSS variant), typed for TS.
 *
 * Splits text into chars/words/lines and animates them into view with GSAP.
 * Uses gsap/SplitText (free since GSAP 3.13) + ScrollTrigger, guarded by
 * document.fonts.ready so CJK glyphs measure correctly before splitting.
 */
