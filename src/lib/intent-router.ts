...
const CRISIS = [
  // zh
  "自杀", "轻生", "不想活", "想死", "自残", "割腕", "跳楼", "服药过量", "杀了他", "杀了她", "杀人", "报复社会",
  // en
  "suicide", "kill myself", "end my life", "want to die", "self harm", "self-harm",
  "cut myself", "overdose", "kill him", "kill her", "hurt someone",
];

const DESTINY = [
  // zh
  "命盘", "星盘", "八字", "紫微", "紫薇", "命理", "运势", "星座", "占星", "占卜",
  "算命", "解读", "看盘", "流年", "大运", "婚姻线", "事业运", "财运", "桃花",
  "水星", "金星", "火星", "木星", "土星", "月亮", "上升", "下降", "宫位",
  // en
  "natal", "birth chart", "horoscope", "astrology", "zodiac", "bazi", "ziwei",
  "jyotish", "vedic", "dasha", "transit", "synastry", "reading", "fortune",
  "mercury", "venus", "mars", "jupiter", "saturn", "ascendant", "midheaven",
...
const ORDER = [
  ...
  "续费", "开通失败", "未到账", "涨价", "优惠券", "价格",
  // en
  "order", "payment", "paid", "refund", "charge", "charged", "billing", "invoice",
  "receipt", "subscription", "membership", "renew", "renewal", "coupon",
];

const PRODUCT = [
  // zh
  "怎么用", "如何使用", "登录", "登陆", "注册", "密码", "报告", "生成失败", "打不开",
  "闪退", "崩溃", "卡顿", "白屏", "黑屏", "加载不出", "报错", "bug",
  "首页", "个人主页", "命盘保存", "命盘删除",
  // en
  "how do i", "how to", "login", "log in", "sign in", "sign up", "password", "reset",
  "generate", "download", "install", "crash", "crashed", "frozen", "blank",
  "won't load", "cannot load", "error", "not working",
];

const OUT_OF_SCOPE = [
  // zh
  "帮我写代码", "写代码", "python", "javascript", "typescript", "sql", "写作业",
  "翻译成", "帮我翻译", "写一篇", "文案", "营销文案", "小红书文案", "抖音脚本",
  "天气", "股票", "新闻", "菜谱", "食谱", "推荐电影", "推荐游戏",
  // en
  "write code", "write me code", "debug my", "fix my code", "javascript function",
  "translate this", "translate to", "write an essay", "write a poem", "homework",
  "marketing copy", "ad copy", "recipe", "movie recommendation", "stock price",
  "weather forecast", "news about",
];
