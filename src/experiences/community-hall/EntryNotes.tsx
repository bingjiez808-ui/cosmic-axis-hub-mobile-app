/**
 * 同门 · 入馆问笺 (Entry Notes) — the legacy "traveler identity + quest board"
 * experience, preserved verbatim from the previous /community page and now
 * demoted to an optional section inside the Hall of Beings. It is a personal
 * self-reflection surface and has nothing to do with letter delivery.
 */
