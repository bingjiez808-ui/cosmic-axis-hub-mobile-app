...
export const LIFE_EXPERIMENTS: LifeExperiment[] = [
  {
    ...
    costEffects:      { love: -2, social: -1, family: -1 },
    shortTerm: {
  ...
  },
  {
    ...
    costEffects:      { health: -3, family: -3, love: -2 },
    shortTerm: {
  ...
  },
  {
    ...
    startAge: 28,
    dimensionEffects: { love: +5, social: +3, health: +3, career: +2 },
    costEffects:      { family: -1 },
    shortTerm: { zh: "短期可能有摩擦, 但透支感明显下降。", en: "Short-term friction rises briefly; drain drops noticeably." },
    midTerm:   { zh: "关系与健康曲线更稳, 事业选择空间被保住。", en: "Love, social, and health steady; career choice-space is preserved." },
  ...
  },
  {
    ...
    startAge: 38,
    dimensionEffects: { family: +7, love: +3, health: +2 },
  ...
  },
  {
    ...
    startAge: 32,
    dimensionEffects: { health: +8, career: +2, love: +2 },
  ...
  },
  {
    ...
    startAge: 33,
    dimensionEffects: { career: +6, social: +3, love: +2, health: +3 },
